...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name:"MKPlayer", url: "https://mkplayer.blob.core.windows.net/$web/ios_tvos_rc_build/MKPlayer-1.3.2-rc.1.zip", checksum: "d0e3435a57957d59b27e71cf1d8acfac826a3735558a8ea516eefa2fb18a07ef"),
        .binaryTarget(
          name: "asid_ott_sdk",
