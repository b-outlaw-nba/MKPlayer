...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name:"MKPlayer" , url: "https://mkplayer.blob.core.windows.net/$web/ios_tvos_rc_build/MKPlayer-1.3.2-rc.1.zip", checksum: "414a3d24a74009e871ce5d23542f7f23048e5c3cc5c37ee5a28c6d0846988905"),
        .binaryTarget(
          name: "GoogleCast",
