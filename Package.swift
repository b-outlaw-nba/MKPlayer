...
let package = Package(
    ...
    targets: [
        .target(name: "MKPlayerPackage",
                ...
                cSettings: [
                    .headerSearchPath("bitmovin-analytics-collector-ios/BitmovinAnalyticsCollector/Classes/"),
                    .define("BUILD_LIBRARY_FOR_DISTRIBUTION", to: "YES")
                ],
                linkerSettings: [
                    .linkedFramework("BitmovinAnalyticsCollector/Classes/")
                ]
        ),
        
        .target(name: "MKPlayerPackageWrapper",
                dependencies: [ "Alamofire", "OMSDK_Mediakind", "MKPlayer", "GoogleCast","BitmovinAnalyticsCollector", "asid_ott_sdk",
        ...
        .target(name: "BitmovinAnalyticsCollector",
                sources: ["Sources/"]
                ),
